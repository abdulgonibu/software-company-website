...
Route::prefix('technologies')->group(function(){
	route::get('/view', 'Backend\DesktopController@view')->name('technologies.view');
	route::get('/add', 'Backend\DesktopController@add')->name('technologies.add');
	route::post('/store', 'Backend\DesktopController@store')->name('technologies.store');
	route::get('/edit/{id}', 'Backend\DesktopController@edit')->name('technologies.edit');
	route::post('/update/{id}', 'Backend\DesktopController@update')->name('technologies.update');
	route::get('/delete/{id}', 'Backend\DesktopController@delete')->name('technologies.delete');
});
