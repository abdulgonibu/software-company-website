  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Bannar Manage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Mission List
                 ...
                 <a class="btn btn-success float-right btn-sm" href="{{ route('bannars.add')}}"><i class="fa fa-plus-circle"></i>Add Bannar</a>
              @endif
                </h3>
              </div><!-- /.card-body -->
              <div class="card-body">
