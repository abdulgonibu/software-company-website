  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Bannar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Add Bannar
                 <a class="btn btn-success float-right btn-sm" href="{{ route('bannars.view')}}"><i class="fa fa-list"></i> Bannar List</a>
                </h3>
              </div><!-- /.card-body -->
              <div class="card-body">
              	<form method="post" action="{{ route('bannars.store')}}" id="myForm" enctype="multipart/form-data">
              		@csrf
              		<div class="form-row">
